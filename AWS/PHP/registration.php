...
if (($_SERVER['REQUEST_METHOD'] == 'POST') && isset($_POST['submit'])) {
    ...
    try {
        ...
        die("1 Database error: " . $e->getMessage());
    }
    ...
    if (!isset($errMSG)) {
        try {
            $stmt = $con->prepare('INSERT INTO user(name, password) VALUES(:username, :password)');
            $stmt->bindParam(':username', $username);
            ...
            die("2 Database error: " . $e->getMessage());
        }
    ...
    <form id="form" method="post" enctype="multipart/form-data" class="form-horizontal"
        ...
        <table class="table table-responsive">
            <tr>
                ...
                <td><input class="form-control" type="text" name="<? echo $r1; ?>" placeholder="아이디를 입력하세요."
            ...
            <tr>
                ...
                <td>
                    <input class="form-control" type="password" name="<? echo $r2; ?>" placeholder="패스워드를 입력하세요"
                           autocomplete="off" readonly
                           onfocus="this.removeAttribute('readonly');"/>
            ...
            <tr>
                ...
                <td>
                    <input class="form-control" type="password" name="<? echo $r3; ?>" placeholder="패스워드를 다시 한번 입력하세요"
                           autocomplete="off" readonly
                           onfocus="this.removeAttribute('readonly');"/>
            ...
            <? // echo $r4; ?><!--" placeholder="프로필을 입력하세요" autocomplete="off" readonly -->
            <!--    onfocus="this.removeAttribute('readonly');" />-->
            <!--            <input type="hidden" name="__autocomplete_fix_-->
            <? // echo $r4; ?><!--" value="newuserprofile" /> -->
            <!--        </td>-->
            <!--    </tr>-->
            <tr>
                <td colspan="2" align="center">
                    <button type="submit" name="submit" class="btn btn-primary"><span
                                class="glyphicon glyphicon-floppy-save"></span>&nbsp; 저장
                    </button>
                </td>
            </tr>
        </table>
